...
String.prototype.bowlderize = function () {
  ...
  {
    if(isVowel(this.charAt(i)))
    {
      output += "*"
    }
    else
      output += this.substring(i, i + 1)
  }
  return output
}
function isVowel(x) {  return /[aeiouAEIOU]/.test(x); } // Code borrowed from https://stackoverflow.com/questions/26926994/javascript-check-if-character-is-a-vowel
// END
...
function myNew(constructor, ...args) {
  //START
  let thisObj = Object.create(constructor.prototype)
